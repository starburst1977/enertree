    ...
    <DropdownMenu>
      <DropdownMenuTrigger className="w-full rounded-md ring-neutral-950 hover:bg-neutral-100 hover:text-neutral-900 focus-visible:outline-none focus-visible:ring-2 data-[state=open]:bg-neutral-100 dark:ring-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-neutral-50 dark:data-[state=open]:bg-neutral-800">
        <div className="flex items-center gap-1.5 overflow-hidden px-2 py-1.5 text-left text-sm transition-all">
          <div className="flex h-5 w-5 items-center justify-center rounded-sm bg-green-600 text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900">
      ...
      <DropdownMenuContent
        ...
        sideOffset={4}
      >
        <DropdownMenuLabel className="text-xs font-normal text-blue-600 dark:text-neutral-400">
          Data Centers
        </DropdownMenuLabel>
        {teams.map((team, index) => (
          ...
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-sm bg-green-600 text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900">
        ...
        <DropdownMenuItem className="gap-2 px-1.5">
          ...
          <div className="font-medium text-neutral-500 dark:text-neutral-400">Add workspace</div>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  )
